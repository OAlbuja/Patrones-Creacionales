...
namespace DesignPatterns.Repositories
{
    ...
    {
        private readonly MemoryCollection _memoryCollection = MemoryCollection.Instance; //cambio de la lista por la Clase MemoryCollection que implementa el patron singleton
